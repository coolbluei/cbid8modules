...
/**
 * Provides a 'DashboardEntityQueueBlock' block.
 *
 * @Block(
 *  id = "dashboard_entity_queue_block",
 *  admin_label = @Translation("Dashboard Entity queue block"),
 * )
 */
class DashboardEntityQueueBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    $form = \Drupal::formBuilder()->getForm('Drupal\cbi_dashboard\Form\EntityQueueForm');
    ...
    $block_id = 'views_block:hero-hero_queue_block';
